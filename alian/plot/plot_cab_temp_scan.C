...
const std::vector<FilePair> kPairs = {
    {"output/jewel_Ti300MeV/eec_R04_100_120_1834257.root",
     "output/eec_R04_100_120_1707049.root",
     "T_{i} = 300 MeV", kRed,     1},
    {"output/eec_R04_100_120_1703291.root",
     "output/eec_R04_100_120_1707049.root",
     "T_{i} = 590 MeV", kBlue,    1},
};
// recoil off:
// const std::vector<FilePair> kPairs = {
...
void plot_cab_temp_scan()
{
    ...
    MakePlot("c_cab",
             ...
             "C_{AB}(PbPb/pp)",
             0.5, 2.5,
             "output/cab_overlay_temp_scan.pdf");

    MakePlot("c_eecab",
             GetEECab,
             "EEC_{AB}(PbPb/pp)",
             0.4, 2.5,
             "output/eecab_overlay_temp_scan.pdf");
