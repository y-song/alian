...
Example usage:
python analysis/test/embed.py -i1 /rstorage/alice/run3/data/LHC24_ppref/BerkeleyTrees/69/BerkeleyTree.root -i2 /rstorage/alice/run3/data/LHC25ae_mb_100/BerkeleyTrees/1/BerkeleyTree.root -c config/embed.yaml -o output/embed.root
"""
